...
module.exports = angular.module('Tested', [
    'ngRoute','ngResource','ngSanitize','ngCookies','ngAnimate','ngAria','ngMessages','ngMaterial',
    'ngFileUpload','configs','controllers','services','filters','directives'
]).config(['$httpProvider', '$locationProvider', '$routeProvider', '$animateProvider', '$mdThemingProvider',
    function($httpProvider, $locationProvider, $routeProvider, $animateProvider, $mdThemingProvider) {
        // 전역 요청/응답 캐치
